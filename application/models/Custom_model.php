...
class Custom_model extends CI_Model
{
     ...
     * @return array
     */
    public function getRowsSorted($table, $where = [], $or_where = [], $sort_column = '', $sort = 'ASC', $limit='')
    {
        $this->db->select('*');
        $this->db->where($where);
        if (is_array($or_where)) {
    ...
    public function getRowsSort($table, $where = [], $or_where = [], $sort_column = 'created_date', $sort = 'DESC', $limit='')
    {
        $this->db->select('*');
        $this->db->where($where);
        if (is_array($or_where)) {
